...
# Database — PostgreSQL (đọc từ .env)
DATABASES = {
    'default': {
...
# VNPay Configuration (đọc từ .env – KHÔNG hardcode)
VNPAY_URL = os.environ['VNPAY_URL']
VNPAY_TMN_CODE = os.environ['VNPAY_TMN_CODE']
VNPAY_HASH_SECRET = os.environ['VNPAY_HASH_SECRET']
...
SESSION_COOKIE_NAME = 'payment_sessionid'
